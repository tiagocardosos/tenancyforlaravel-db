<div x-data>
    ...
    <form>
        <div class="w-full mb-8">
            ...
            <input type="text" class="w-full rounded mt-2 @error('restaurant.restaurant') border-red-700 @enderror"
        ...
        <div class="w-full mb-8">
            ...
            <input type="text" class="w-full rounded mt-2 @error('restaurant.description') border-red-700 @enderror"
